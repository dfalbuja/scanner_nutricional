...
export default function ProductoScreen() {
  ...
  <Text style={styles.title}>Producto escaneado: {product.product_name || 'Desconocido'}</Text>
  ...
  <View style={styles.table}>
    <View style={styles.headerRow}>
      <Text style={[styles.headerCell, { flex: 1.5 }]}>Información nutricional</Text>
      <Text style={[styles.headerCell, { flex: 1 }]}>Por 100g / 100ml</Text>
    </View>

    {[
      ['Energía (Calorías)', nutriments['energy_100g'] + ' kJ', '(' + nutriments['energy-kcal_100g'] + ' kcal)'],
      ...
      <View style={styles.row} key={idx}>
        ...
        <Text style={[styles.cell, { flex: 1 }]}>
          {value !== null && value !== undefined && String(value).trim() !== '' ? `${value} ${unit}` : '-'}
        </Text>
      </View>
    ))}
  </View>
